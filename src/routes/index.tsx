...
/**
 * Image pipeline shape: ONE Agnes AI key with a small number of renders in
 * flight at a time (server-side gate). Each lane draws ONE prompt with its
 * exact text, so lanes stay modest and the single key is never flooded.
 */
